...
public class CCDatabaseTests {
    ...
    /**
     * Constructs a lookup queue to test. This should be updated to construct your
     * implementation.
     *
     * @return The lookup queue implementation to test.
     */
    public static CCDatabase makeSortedCCDatabase() {
        return new SortedArrayCCDatabase();
    }
    ...
    public static CCDatabase makeRobinHoodCCDatabase() {
        return new RobinHoodHashing();
    }

    /**
     * Tests that the deleteAccount operation works on the sorted array database.
     ...
     * database. This relies on createAccount and getAccount working to first create
     * the account and afterwards verify that the credit limits were adjusted.
     */
    @Test
    ...
    /**
     * Tests that the getAccount operation works on the sorted array database. This
     * relies on createAccount working as accounts must be created to be gotten.
     */
    @Test
     ...
     * This relies on createAccount working as accounts must be created to be used
     * for a purchase.
     */
    @Test
    ...
    public void stressTestSorted() {
        ...
        for (int i = 0; i < 2 * size; i++) {
            ...
            // System.out.println(database.createAccount(accounts.get(i), "Name", "Address",
            // 1000.0, 0.0));
        }
     ...
     * database. This relies on createAccount working as accounts must be created to
     * be deleted.
     */
    @Test
    ...
    /**
     * Tests that the makePurchase operation works on the simple hash table
     * database. This relies on createAccount working as accounts must be created to
    ...
    /**
     * Tests that the getAccount operation works on the Robin Hood hash table
     * database. This relies on createAccount working as accounts must be created to
     * be gotten.
     */
    @Test
    ...
    /**
     * Tests that the makePurchase operation works on the Robin Hood hash table
     * database. This relies on createAccount working as accounts must be created to
     * be used for a purchase.
     */
    @Test
    ...
    /**
     * Tests that all of the operations work on a large Robin Hood hash table
     * database.
     */
    @Test(timeout = 1000)
...
//
//        @Override
//        public boolean createAccount(long accountNumber, String name, String address, double creditLimit,
//                double balance) {
//            return false;
//        }
//
